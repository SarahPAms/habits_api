...
ActiveRecord::Schema.define(version: 20170724165051) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.index ["goal_id"], name: "index_categories_on_goal_id", using: :btree
  end
  ...
  create_table "habits", force: :cascade do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["frequency_id"], name: "index_habits_on_frequency_id", using: :btree
  end
